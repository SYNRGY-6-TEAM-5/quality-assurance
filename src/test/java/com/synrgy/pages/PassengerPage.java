...
public class PassengerPage extends BaseTest {
    ...
    public void selectSavePassengerData1(){
        wait.until(ExpectedConditions.presenceOfElementLocated(passengerData1));
        driver.findElement(passengerData1).click();
    }

    public void selectSavePassengerData2(){
        wait.until(ExpectedConditions.presenceOfElementLocated(passengerData2));
        driver.findElement(passengerData2).click();
    }

    public void doSelectPassengerData1(){
        tapPassenger1();
        selectSavePassengerData1();
    }

    public void doSelectPassengerData2(){
        tapPassenger2();
        selectSavePassengerData2();
